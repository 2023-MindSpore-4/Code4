...
def load_data(category_file, subject_id, num_sessions, num_parts):
    ...
    """
    label_file = '/media/chem/新加卷/data/feature/%s.mat' % category_file
    ...
    for i in range(num_sessions):
        data_file = '/media/chem/新加卷/data/fmri/Subject%d/preprocessed/fmri_Subject%d_Session%d.h5' % (subject_id, subject_id, i+1)
    ...
    sj.labels = torch.from_numpy(category_feat[stims-1, :].astype(float))
