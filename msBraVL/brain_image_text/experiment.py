...
from brain_image_text.networks.QNET import QNet, QNet2, QNet3
...
class BrainImageText(BaseExperiment):
    ...
    def set_dataset(self):
        ...
        train_brain = sio.loadmat(os.path.join(brain_dir, 'fmri_train_data' + stability_ratio + '.mat'))['data'].astype(
            'double')
        ...
        train_label = sio.loadmat(os.path.join(brain_dir, 'fmri_train_data' + stability_ratio + '.mat'))[
        ...
        test_brain = sio.loadmat(os.path.join(brain_dir, 'fmri_test_data' + stability_ratio + '.mat'))['data'].astype(
            'double')
        ...
        test_label = sio.loadmat(os.path.join(brain_dir, 'fmri_test_data' + stability_ratio + '.mat'))[
            'class_idx'].T.astype('int')
        ...
        if self.flags.test_type == 'normal':
            ...
            train_brain, val_brain, train_label, val_label = train_test_split(train_brain, train_label_stratify,
                                                                              test_size=0.2,
                                                                              stratify=train_label_stratify)
            train_image, val_image, train_label, val_label = train_test_split(train_image, train_label_stratify,
                                                                              test_size=0.2,
                                                                              stratify=train_label_stratify)
            train_text, val_text, train_label, val_label = train_test_split(train_text, train_label_stratify,
                                                                            test_size=0.2,
                                                                            stratify=train_label_stratify)
    ...
    def set_Qmodel(self):
        ...
        Q2 = QNet2(input_dim=self.flags.m2_dim, latent_dim=self.flags.class_dim).cuda()
        Q3 = QNet3(input_dim=self.flags.m3_dim, latent_dim=self.flags.class_dim).cuda()
        return Q1, Q2, Q3
